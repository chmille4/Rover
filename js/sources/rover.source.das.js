var DasSource = RoverSource.extend({
   ...
   fetch: function(min, max, callback, track, direction, drawOnResponse) {
      ...
      var fullUrl = this.url + '/features?segment=' + this.chromosome + ':'  + this.request.min + "," + this.request.max + ';type=' + this.typeFilter;     
